...
public class GenerateTicketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qrBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Dialog qrCode = new Dialog(GenerateTicketActivity.this);
                ...
                qrCode.getWindow().setBackgroundDrawable(
                        new ColorDrawable(android.graphics.Color.TRANSPARENT));
                ImageView myImage = (ImageView) qrCode.findViewById(R.id.rq_code);
                ImageView closeImage = (ImageView) qrCode.findViewById(R.id.close_image);
    ...
    private void writeTextPlainTag(String payment) {
        Intent intent = new Intent(GenerateTicketActivity.this, NFCActivity.class);
