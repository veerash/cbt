...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent callingHomeIntent = new Intent(MapsActivity.this, PaymentContactActivity.class);
...
//            public void onMapClick(LatLng point) {
        ...
        MarkerPoints.add(mSrcPnt);
        MarkerPoints.add(mDestPnt);

        // Creating MarkerOptions
        MarkerOptions options = new MarkerOptions();

        // Setting the position of the marker
        options.position(mSrcPnt);
        MarkerOptions options1 = new MarkerOptions();
        options1.position(mDestPnt);
        BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.pickup_marker);
        options.icon(icon);
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLng(mSrcPnt));
